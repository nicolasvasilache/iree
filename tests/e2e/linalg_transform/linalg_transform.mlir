...
// R-UN:   --iree-preloaded-transforms=%p/transform_dialect_dispatch_spec.mlir \
/// Specify the codegen strategy with the transform dialect.
// R-UN:   --iree-preloaded-transforms=%p/transform_dialect_codegen_spec.mlir \
// R-UN: %s | FileCheck %s
...
// RUN:   --iree-preloaded-transforms=%p/transform_dialect_dispatch_spec.mlir
